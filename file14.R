...
summary(fit3)#we made rank a factor the the lowest rank will be used as a reference hence one rank is removed from coefficients
#estimates are in log form
#AIC:Akaike information citeria- it estimates the quality of one model relative to the other
...
cbind(newdata1, predictProb=predict(fit3, newdata = newdata1, type="response"))#'response' calculates the numerical value, we can also calculate the categorical value
