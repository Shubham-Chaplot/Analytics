...
(ts(sales, start=1, end=12, freq=2)) #all 24 are taken
(ts(sales, start=1, end=12, freq=3)) #
(ts(sales, start=1, end=12, freq=4)) # Qtrly series, if data points are less then it reuses the data given
...
(tsales3a = ts(sales, start=c(2017, 1), frequency=12)) # years 2017 to 2018, 24 values, monthwise 24 observations spread to 2 years, makes monthly data
ts(sales, start=c(2017, 4), end=c(2018,3), frequency=12)
ts(sales, start=c(2017, 2), frequency=12)  # different start month
ts(sales, start=c(2017, 2), frequency=4)  # different start month, makes quarterly data
plot(ts(sales, start=c(2017,1), frequency=1))  # different start month
ts(sales, start=c(2017,1), frequency=1)# makes yearly data
